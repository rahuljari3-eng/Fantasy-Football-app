...
export function buildSystemPrompt(leagueContext: LeagueContext): string {
  ...
  return [
    ...
    "For trade fairness, call evaluate_trade (it returns BOTH week and rest-of-season). For start/sit use compare_players (prefer weekValue) and check byes/schedule.",
